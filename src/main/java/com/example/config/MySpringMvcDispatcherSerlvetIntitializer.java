...
public class MySpringMvcDispatcherSerlvetIntitializer extends AbstractAnnotationConfigDispatcherServletInitializer implements IMySpringMvcDispatcherSerlvetIntitializer {
    @Override
